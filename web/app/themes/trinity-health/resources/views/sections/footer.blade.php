    ...
    <div class="py-16">
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="lg:col-span-2">
          <div class="flex items-center space-x-3 mb-6">
            ...
            <div>
              ...
              <p class="text-white text-sm">Zambia</p>
            </div>
          </div>
          ...
          <div class="space-y-3">
            <div class="flex items-center space-x-3">
              ...
              <span class="text-white">Lusaka, Zambia</span>
            </div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <a href="tel:+260123456789" class="text-white hover:text-[#a61a1a] transition-colors">
                +260 123 456 789
              </a>
            </div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <a href="mailto:info@trinityhealthzambia.com" class="text-white hover:text-[#a61a1a] transition-colors">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <a href="{{ home_url('/about') }}" class="text-white hover:text-[#a61a1a] transition-colors">
                About Us
              </a>
            </li>
            <li>
              <a href="{{ home_url('/services') }}" class="text-white hover:text-[#a61a1a] transition-colors">
                Our Services
              </a>
            </li>
            <li>
              <a href="{{ home_url('/audiology-services') }}" class="text-white hover:text-[#a61a1a] transition-colors">
                Audiology Services
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="{{ home_url('/appointments') }}" class="text-white hover:text-[#a61a1a] transition-colors">
                Book Appointment
              </a>
            </li>
          </ul>
    ...
    <div class="border-t border-gray-800 py-8">
      <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <div class="flex items-center space-x-6">
          <a href="{{ home_url('/privacy-policy') }}" class="text-white hover:text-[#a61a1a] text-sm transition-colors">
            Privacy Policy
          </a>
          <a href="{{ home_url('/terms-of-service') }}" class="text-white hover:text-[#a61a1a] text-sm transition-colors">
            Terms of Service
          </a>
          <a href="{{ home_url('/accessibility') }}" class="text-white hover:text-[#a61a1a] text-sm transition-colors">
            Accessibility
          </a>
        </div>
      </div>
