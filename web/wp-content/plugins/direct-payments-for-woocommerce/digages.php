...
function digages_plugin_on_activation() {
    ...
    add_option('digages_wdpp_data_usage_second', 'no');
    add_option('digages_wdpp_optional_proof', 'no');
}
...
//Help improve Ads
add_action('admin_notices', 'digages_data_usage_notice_help_improve');
add_action('admin_init', 'digages_handle_data_usage_actions_help_improve');
include_once(plugin_dir_path(__FILE__) . 'ads/others/help-improve.php');

//Help improve Ads
add_action('admin_notices', 'digages_optional_proof_notice_optional_proof');
add_action('admin_init', 'digages_handle_optional_proof_actions_optional_proof');
include_once(plugin_dir_path(__FILE__) . 'ads/others/optional-proof.php');
