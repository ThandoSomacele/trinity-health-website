...
⭐ Stars, Stripes & Savings: Enjoy 50% Off!
</div>
<div class="">
Celebrate Independence Day with 50% off. Enjoy multiple payment methods, email payment confirmations, and so much more. Upgrade to PRO today at an unbeatable rate!
</div>
...
<div class="">
<a href="<?php echo esc_url($skip_url);?>" ><button type="button" class="btn2">Maybe Later</button></a>
</div>
