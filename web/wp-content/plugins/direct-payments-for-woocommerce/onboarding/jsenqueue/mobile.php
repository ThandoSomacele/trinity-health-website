...
function digages_enqueue_woodp_onboarding_mobile_scripts() {
    ...
    if (isset($_GET['page']) && $_GET['page'] === 'digages-woodp-onboarding') {
        ...
        wp_enqueue_script('mobile-transfer-edit', plugin_dir_url(__FILE__) . '../../assets/js/mobilemon/mobile-transfer-edit.js', array('jquery'), '2.1.3', true);
...
add_action('admin_enqueue_scripts', 'digages_enqueue_woodp_onboarding_mobile_scripts');
?>
