...
wp_enqueue_style('digages-admin-woodp-remove-onboarding', plugin_dir_url(__FILE__) . 'assets/css/removewordpress.css', array(), '2.1.3', 'all'); 
    
wp_enqueue_style('digages-admin-woodp-onboarding', plugin_dir_url(__FILE__) . 'assets/css/styles.css', array(), '2.1.3', 'all'); 
wp_enqueue_style('digages-admin-woodp-onboarding-form', plugin_dir_url(__FILE__) . 'assets/css/forms.css', array(), '2.1.3', 'all'); 
wp_enqueue_style('digages-admin-woodp-onboarding-table', plugin_dir_url(__FILE__) . 'assets/css/table.css', array(), '2.1.3', 'all'); 
wp_enqueue_style('digages-admin-woodp-onboarding-addaccount', plugin_dir_url(__FILE__) . 'assets/css/addaccount.css', array(), '2.1.3', 'all'); 
wp_enqueue_style('digages-admin-woodp-onboarding-menu', plugin_dir_url(__FILE__) . 'assets/css/menu.css', array(), '2.1.3', 'all'); 
wp_enqueue_style('digages-admin-woodp-onboarding-popup', plugin_dir_url(__FILE__) . 'assets/css/popup.css', array(), '2.1.3', 'all'); 
...
function digages_enqueue_woodp_onboarding_scripts() {
    ...
    // )) {
        ...
        wp_enqueue_style('digages-admin-woodp_onboarding', plugin_dir_url(__FILE__) . 'assets/css/styles.css', array(), '2.1.3', 'all'); 
    // }
}
