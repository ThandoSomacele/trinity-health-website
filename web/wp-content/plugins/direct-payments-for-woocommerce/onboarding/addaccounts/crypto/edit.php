    ...
    <div class="digages-onboard-addacnt-popup-container" id="editcrypto">
        ...
        <div class="digages-onboard-addacnt-popup-footer">
                ...
                <?php wp_nonce_field('save_crypto_transfer_settings', 'crypto_transfer_nonce'); ?>
                    <button type="button" class="digages-onboard-addacnt-popup-save" id="edit_crypto_account_button">Update</button>
                </div>
                <div class="">
                    <button type="button" class="digages-onboard-addacnt-popup-cancel">Cancel</button>
                </div>
        </div>
    </div>
