    ...
    class Digages_Gateway_Direct_Pay extends WC_Payment_Gateway {
        ...
        public function init_form_fields() { 
            ...
            $this->form_fields = array(
                ...
                'enable_payment_proof' => array(
                        'type' => 'checkbox',
                        'label' => 'Collect payment proof from customers',
                        'description' => '<a href="https://digages.com/direct-payments-for-woocommerce/" target="_blank">Upgrade to PRO</a> to make payment proof upload optional.',
                        'default' => 'yes', 
                        'disabled' => true,
                        'class' => 'digages_enable_payment_proof'
                    ),
                        'accent_color' => array(
                        'title' => 'Accent Color',
                        'type' => 'color',
