...
// Ensure WooCommerce is active
    ...
    // Enqueue popup CSS and JS
        wp_enqueue_style('digages-woocommerce-css', plugin_dir_url(__FILE__) . '../../../../woocommerce/assets/css/admin.css', array(), '2.1.3', 'all');
...
<div class="text-start">
  ...
  <div class="rowt rowt-colts-1 rowt-colts-sm-1 rowt-colts-md-1">
    ...
    <div class="colt rrwtp"> 
        ...
        <?php }  else { ?>
              <button type="button" id="add_account_button" class="trddbtnot22 digages-onboard-addacnt-add-btn digages-onboard-addacnt-popup-trigger" data-target="banktransfer" > <i class="bi bi-plus"></i> Add Account</button>
          <?php } ?>   
    </div>
  </div>
    </div>
    ...
    <thead>
        <tr>
            ...
            <th class="teeb">Status</th>
              ...
              <?php }  else { ?>
                <th class="teeb text-end digages-onboard-addacnt-add-btn digages-onboard-addacnt-popup-trigger" data-target="banktransfer"><span class="btact"><i class="bi bi-plus"></i></span></th>
                <?php } ?> 
        </tr>
    </thead>
    <tbody>
    ...
    <span class="eedtbt edit-account-bank digages-onboard-addacnt-popup-trigger" data-index="<?php echo esc_attr($index); ?>" data-target="editbanktransfer">Edit</span> | 
...
<?php
include plugin_dir_path(__FILE__) . 'bank/edit.php';
?>
    <form id="bank_account_form">
        <!-- for popup -->
      <?php
            if (count($saved_bank_accounts) < 1) { 
            include plugin_dir_path(__FILE__) . 'bank/add.php';
            } 
            else {
