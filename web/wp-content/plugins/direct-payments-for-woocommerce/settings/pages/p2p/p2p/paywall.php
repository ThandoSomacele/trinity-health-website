...
?>
<?php
$logo = plugins_url('../../../../onboarding/assets/img/logo1.svg', __FILE__); 
$bank= plugins_url('../../../../onboarding/assets/img/bank.svg', __FILE__); 
$crypto = plugins_url('../../../../onboarding/assets/img/crypto.svg', __FILE__); 
$mobile = plugins_url('../../../../onboarding/assets/img/mobile.svg', __FILE__); 
$p2p = plugins_url('../../../../onboarding/assets/img/p2p.svg', __FILE__);
...
<div class="digages-onboard-addacnt-popup-overlay"></div>
    ...
    <div class="digages-onboard-addacnt-popup-container" id="paywall">
        ...
        <div class="digages-onboard-addacnt-popup-content2 ">
            ...
            Free users can add <b>one (1) peer-to-peer account.</b> <a href="https://digages.com/direct-payments-for-woocommerce/" target="_blank">Upgrade to PRO</a> for unlimited accounts. Add other payment methods below.
            </div>
...
<div class="digages-onboard-addacnt-popup-content3">
        ...
        <div class="digages-onboard-addacnt-popup-footer">
                <div>
                <a href="https://digages.com/direct-payments-for-woocommerce/" target="_blank" style="text-decoration: none;"> <button type="button" class="digages-onboard-addacnt-popup-save">Upgrade to PRO</button></a>
                </div>
                <div class="">
                    <button type="button" class="digages-onboard-addacnt-popup-cancel digages-onboard-addacnt-popup-close">Close</button>
                </div>
        </div>
    </div>
