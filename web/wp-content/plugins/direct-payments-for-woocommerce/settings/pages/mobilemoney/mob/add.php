...
?>
<div class="digages-onboard-addacnt-popup-container-adjustw">

<div class="digages-onboard-addacnt-popup-overlay"></div>
    
    <div class="digages-onboard-addacnt-popup-container" id="qmobilea">
        ...
        <div class="digages-onboard-addacnt-popup-footer">
                <div>
                    <button type="button" class="digages-onboard-addacnt-popup-save" id="save_mobile_account_button">Save</button>
                </div>
                <div class="">
                    <button type="button" class="digages-onboard-addacnt-popup-cancel digages-onboard-addacnt-popup-close">Cancel</button>
                </div>
        </div>
    </div>
