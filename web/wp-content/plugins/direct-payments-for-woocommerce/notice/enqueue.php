...
function digages_notice_enqueue_admin_scripts($hook) {
    ...
    wp_enqueue_style('digages-notice-css', plugin_dir_url(__FILE__) . 'css/notice.css', array(), '2.1.3', 'all');
    wp_enqueue_script('digages-admin-script', plugin_dir_url(__FILE__) . 'js/digages-admin.js', ['jquery'], '2.1.3', true);
