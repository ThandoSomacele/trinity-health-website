...
function digages_direct_payments_page_content() {
    ...
    switch ($current_subsection) {
        ...
        case 'peer_to_peer':
            ...
            break;
        case 'about':
            echo '<h2>' . esc_html__('Help Center', 'direct-payments-for-woocommerce') . '</h2>';
...
function digages_messages_page_callback() {
    digages_direct_payments_page_content();
    include_once(plugin_dir_path(__FILE__) . '../settings/pages/messages.php');
}
