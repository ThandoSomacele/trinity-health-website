...
<div style="display: none !important;"><select id="bankTransferSelect" class="form-select" hidden></select> </div>
...
<div class="text-center ppsj trstxt">Transfer <b><span class="digages-woodp-order-currency"></span><span class="digages-woodp-order-amount"></span></b> to the mobile money account details below</div>
<div style="display: none !important;"><select id="mobileMoneySelect" class="form-select" hidden></select></div>
<div id="hidden-payment-container">   
...
<div style="display: none !important;"><select id="cryptoMoneySelect" class="form-select" hidden></select></div>
<div id="hidden-payment-container">   
...
<div class="colt text-center kfls digages-check-skip-success"> 
