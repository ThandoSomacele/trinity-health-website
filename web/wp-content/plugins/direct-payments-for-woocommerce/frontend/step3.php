...
$successheading = get_option('digages_popup_messages_title');
$successheading = !empty($successheading) ? $successheading : 'Success! Your payment proof has been submitted.';

$instruction = get_option('digages_popup_messages_instructions');
// If it's empty or null, use a default
$instruction = !empty($instruction) ? $instruction : 'We’ll confirm your payment soon and start processing your order. The receipt will be sent to [Customer_email]';
// Replace placeholder with HTML
$instruction = str_replace('[Customer_email]', '<span class="links"><span class="tumaz_displayEmail"></span></span>', $instruction);
...
<div class="ppsj23"><?php echo wp_kses_post( $successheading ); ?></div> 
<div class="ppsj24"><?php echo wp_kses_post( $instruction ); ?></div> 
</div> 
