...
<footer class="site-footer bg-trinity-primary text-white" role="contentinfo">
    <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="footer-section">
                <!-- Logo -->
                <div class="mb-6">
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="flex items-center text-white hover:text-orange-300 transition-colors">
                ...
                <div class="flex space-x-3">
                    <a href="<?php echo esc_url(get_theme_mod('trinity_health_linkedin_url', '#')); ?>" class="text-orange-400 hover:text-orange-300 transition-colors" target="_blank" rel="noopener">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clip-rule="evenodd"></path>
                        </svg>
                    </a>
                    
                    <a href="<?php echo esc_url(get_theme_mod('trinity_health_youtube_url', '#')); ?>" class="text-orange-400 hover:text-orange-300 transition-colors" target="_blank" rel="noopener">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <a href="<?php echo esc_url(get_theme_mod('trinity_health_twitter_url', '#')); ?>" class="text-orange-400 hover:text-orange-300 transition-colors" target="_blank" rel="noopener">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84"></path>
                        </svg>
                    </a>
                    
                    <a href="<?php echo esc_url(get_theme_mod('trinity_health_instagram_url', '#')); ?>" class="text-orange-400 hover:text-orange-300 transition-colors" target="_blank" rel="noopener">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <a href="<?php echo esc_url(get_theme_mod('trinity_health_facebook_url', '#')); ?>" class="text-orange-400 hover:text-orange-300 transition-colors" target="_blank" rel="noopener">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Contact Details -->
            <div class="footer-section">
                <h3 class="text-orange-400 text-lg font-semibold mb-4"><?php esc_html_e('Contact Details', 'trinity-health'); ?></h3>
                <div class="space-y-3 text-sm">
                    <div class="flex items-start">
                        <svg class="w-4 h-4 mt-1 mr-3 text-orange-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex items-center">
                        <svg class="w-4 h-4 mr-3 text-orange-400" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                            <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                        </svg>
                        <a href="mailto:<?php echo esc_attr(get_theme_mod('trinity_health_email', 'healthcare@gmail.com')); ?>" class="text-gray-300 hover:text-orange-300 transition-colors">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="tel:<?php echo esc_attr(get_theme_mod('trinity_health_phone', '+01 547 547 5478')); ?>" class="text-gray-300 hover:text-orange-300 transition-colors">
            ...
            <!-- Newsletter -->
            <div class="footer-section">
                <h3 class="text-orange-400 text-lg font-semibold mb-4"><?php esc_html_e('Newsletter', 'trinity-health'); ?></h3>
                <div class="mb-4">
                ...
                <form class="newsletter-form" action="#" method="post">
                    <div class="flex">
                        <input type="email" 
                               ...
                               class="flex-1 px-3 py-2 text-sm bg-white bg-opacity-10 border border-gray-600 rounded-l-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent"
                               required>
                        <button type="submit" 
                                class="px-4 py-2 text-sm bg-orange-400 hover:bg-orange-500 text-white rounded-r-md transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-green-900">
        ...
        <div class="border-t border-gray-600 mt-8 pt-6">
            <div class="text-center">
                <p class="text-gray-300 text-sm">
                    ...
                    &copy; <span class="text-orange-400"><?php bloginfo('name'); ?></span> 
