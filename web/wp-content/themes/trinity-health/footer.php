            ...
            <div class="footer-section">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="mailto:<?php echo esc_attr(get_theme_mod('trinity_health_email', 'healthcare@gmail.com')); ?>" class="text-gray-300 hover:text-trinity-gold-light transition-colors">
                ...
                <form class="newsletter-form" action="#" method="post">
                    <div class="flex">
                        <input type="email" 
                               ...
                               class="flex-1 px-3 py-2 text-sm bg-white bg-opacity-10 border border-gray-600 rounded-l-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-trinity-gold focus:border-transparent"
                               required>
                        <button type="submit" 
                                class="px-4 py-2 text-sm bg-trinity-gold hover:bg-trinity-gold-dark text-white rounded-r-md transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-trinity-gold focus:ring-offset-2 focus:ring-offset-green-900">
