...
/**
 * Template Name: Cardiology Service
 * 
 * Individual service page for Cardiology matching MediPro design
 */
...
<section class="relative bg-trinity-maroon py-24 lg:py-32 overflow-hidden">
    ...
    <div class="content-container relative z-10">
        <div class="text-center">
            <!-- Page Title -->
            <h1 class="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Cardiology Services</h1>
            ...
            <nav class="flex justify-center items-center space-x-2 text-white/80">
                ...
                <span>»</span>
                <span class="text-trinity-gold">Cardiology Services</span>
            </nav>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="relative rounded-lg overflow-hidden mb-12">
                    <img src="/wp-content/uploads/2025/09/hero-cardiac.webp"
                ...
                <div class="mb-12">
                    <p class="text-lg text-gray-600 leading-relaxed mb-6">
                        Trinity Health's Cardiology Clinic provides comprehensive heart care services, from preventive screenings to advanced cardiac treatments. Our experienced cardiologists use state-of-the-art diagnostic equipment to evaluate and treat various heart conditions.
                    </p>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        We specialize in managing conditions such as hypertension, coronary artery disease, heart failure, and arrhythmias. Our holistic approach combines medical expertise with lifestyle counseling to help you maintain optimal heart health.
                    </p>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 mb-8">
                        <div class="flex items-start space-x-3">
                            ...
                            <span class="text-lg text-gray-700">ECG & Heart Monitoring</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Echocardiography</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Stress Testing</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Blood Pressure Management</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Cholesterol Management</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Heart Disease Prevention</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Cardiac Rehabilitation</span>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Cardiac Assessment</h3>
                    <p class="text-base text-gray-600 flex-grow">Comprehensive evaluation of your heart health and risk factors.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <p class="text-base text-gray-600 flex-grow">Advanced cardiac tests to accurately diagnose heart conditions.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <p class="text-base text-gray-600 flex-grow">Personalized treatment strategies for your cardiac health.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Ongoing Monitoring</h3>
                    <p class="text-base text-gray-600 flex-grow">Regular follow-ups to track progress and adjust treatment.</p>
