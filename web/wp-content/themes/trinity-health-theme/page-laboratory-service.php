...
/**
 * Template Name: Laboratory Service
 * 
 * Individual service page for Laboratory matching MediPro design
 */
...
<section class="relative bg-trinity-maroon py-24 lg:py-32 overflow-hidden">
    ...
    <div class="content-container relative z-10">
        <div class="text-center">
            <!-- Page Title -->
            <h1 class="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Laboratory Services</h1>
            ...
            <nav class="flex justify-center items-center space-x-2 text-white/80">
                ...
                <span>»</span>
                <span class="text-trinity-gold">Laboratory Services</span>
            </nav>
        </div>
    </div>
</section>
            ...
            <div class="lg:col-span-2">
                ...
                <div class="mb-12">
                    <p class="text-lg text-gray-600 leading-relaxed mb-6">
                        Trinity Health's Laboratory Services provide accurate and timely diagnostic testing essential for effective medical treatment. Our state-of-the-art laboratory is equipped with modern technology and staffed by experienced technicians who ensure precise results for all your diagnostic needs.
                    </p>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        From routine blood tests to specialized diagnostic procedures, we offer a comprehensive range of laboratory services. Our commitment to quality and quick turnaround times ensures that your healthcare providers receive the information they need to make informed decisions about your treatment plan.
                    </p>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 mb-8">
                        <div class="flex items-start space-x-3">
                            ...
                            <span class="text-lg text-gray-700">Complete Blood Count (CBC)</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Blood Chemistry Analysis</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Urinalysis & Stool Tests</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Microbiology & Culture Tests</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Hormone Level Testing</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Pregnancy & Fertility Tests</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">HIV & STI Screening</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo home_url('/services/laboratory'); ?>"
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <span class="font-semibold text-lg">Laboratory Analysis</span>
                            </div>
                        </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Sample Collection</h3>
                    <p class="text-base text-gray-600 flex-grow">Quick and painless sample collection by our trained phlebotomists.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Laboratory Analysis</h3>
                    <p class="text-base text-gray-600 flex-grow">Precise testing using advanced equipment and standardized procedures.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Quality Control</h3>
                    <p class="text-base text-gray-600 flex-grow">Rigorous quality checks to ensure accurate and reliable results.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Results Delivery</h3>
                    <p class="text-base text-gray-600 flex-grow">Fast turnaround with secure delivery of your test results to your doctor.</p>
