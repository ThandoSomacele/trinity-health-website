...
/**
 * Template Name: General Medicine Service
 * 
 * Individual service page for General Medicine matching MediPro design
 */
...
<section class="relative bg-trinity-maroon py-24 lg:py-32 overflow-hidden">
    ...
    <div class="content-container relative z-10">
        <div class="text-center">
            <!-- Page Title -->
            <h1 class="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-6">General Medicine</h1>
            ...
            <nav class="flex justify-center items-center space-x-2 text-white/80">
                ...
                <span>»</span>
                <span class="text-trinity-gold">General Medicine</span>
            </nav>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="relative rounded-lg overflow-hidden mb-12">
                    <img src="/wp-content/uploads/2025/08/general-medicine.webp"
                ...
                <div class="mb-12">
                    <p class="text-lg text-gray-600 leading-relaxed mb-6">
                        Trinity Health's General Medicine department serves as your primary healthcare provider, offering comprehensive medical care for patients of all ages. Our experienced physicians are dedicated to preventive care, early diagnosis, and effective treatment of a wide range of health conditions, ensuring your overall well-being through personalized medical attention.
                    </p>
                    <p class="text-lg text-gray-600 leading-relaxed">
                        We provide routine check-ups, health screenings, immunizations, and management of chronic conditions such as diabetes, hypertension, and respiratory diseases. Our team takes a holistic approach to healthcare, considering all aspects of your health to develop treatment plans that improve your quality of life and promote long-term wellness.
                    </p>
                </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 mb-8">
                        <div class="flex items-start space-x-3">
                            ...
                            <span class="text-lg text-gray-700">Routine Health Check-ups</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Chronic Disease Management</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Preventive Care Services</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Health Screenings & Tests</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Immunization Services</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Minor Injury Treatment</span>
                        </div>
                        <div class="flex items-start space-x-3">
                            <svg class="w-6 h-6 text-trinity-maroon mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span class="text-lg text-gray-700">Health Education & Counseling</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="<?php echo home_url('/audiology-service'); ?>"
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <span class="font-semibold text-lg text-gray-800">Audiology Clinic</span>
                            </div>
                        </a>

                        <!-- General Medicine (Current) -->
                        <a href="<?php echo home_url('/general-medicine-service'); ?>"
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <span class="font-semibold text-lg">General Medicine</span>
                            </div>
                        </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Initial Consultation</h3>
                    <p class="text-base text-gray-600 flex-grow">Comprehensive health assessment to understand your medical history and current concerns.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Diagnostic Testing</h3>
                    <p class="text-base text-gray-600 flex-grow">Conducting necessary tests and examinations to accurately diagnose your condition.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Treatment Planning</h3>
                    <p class="text-base text-gray-600 flex-grow">Developing a personalized treatment plan based on your diagnosis and health goals.</p>
            ...
            <div class="relative">
                <div class="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
                    ...
                    <h3 class="text-2xl font-semibold text-gray-900 mb-3">Ongoing Care</h3>
                    <p class="text-base text-gray-600 flex-grow">Regular follow-ups to monitor progress and adjust treatment for optimal health outcomes.</p>
