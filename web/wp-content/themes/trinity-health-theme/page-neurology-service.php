        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="relative rounded-lg overflow-hidden mb-12">
                    <img src="/wp-content/uploads/2025/09/hero-neurological.webp"
                ...
                <div class="mb-12">
                    <p class="text-lg text-gray-600 leading-relaxed mb-6">
                        Trinity Health's Neurology Clinic specialises in diagnosing and treating disorders of the nervous system. Our neurologists provide expert care for conditions affecting the brain, spinal cord, and peripheral nerves.
                    </p>
